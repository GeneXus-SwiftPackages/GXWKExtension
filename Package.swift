...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "1.6.0-rc.0")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/preview/GXWKExtension-1.6.0-rc.0.xcframework.zip",
			checksum: "7ce52a79a89d1763add70b93bdfb48662ec8ded67258aa08d9fe8c89118e2123"
		)
	]
)