...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-1.0.0-beta+20230502131235.xcframework.zip",
			checksum: "c1397f8b4d5d04753ab23fbfa656407357e92739654ea02a8e53dcf874281cda"
		)
	]
)