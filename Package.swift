...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "4.1.5")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/releases/GXWKExtension-4.1.5.xcframework.zip",
			checksum: "0fa736fd2a81d440cdd1b967cd315577f31ea890fba5283a8cad5e7cddcc1f96"
		)
	]
)