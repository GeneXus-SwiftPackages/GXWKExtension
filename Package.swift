...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-1.0.0-beta+20230327200102.xcframework.zip",
			checksum: "10a53918d9be218e4ee74602dfcd102fe2d876424d7f016211f91d9b650e2485"
		)
	]
)