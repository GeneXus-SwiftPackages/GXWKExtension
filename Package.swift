...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "1.4.0-beta.17")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-1.4.0-beta.17.xcframework.zip",
			checksum: "bc817a508a7f72aee5406d3ddcdc532efb37aefd356d2231a73d70f435088dfc"
		)
	]
)