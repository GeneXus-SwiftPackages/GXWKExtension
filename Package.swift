...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "1.3.0")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/releases/GXWKExtension-1.3.0.xcframework.zip",
			checksum: "d401ba58ac21c4459aef83731a547e88d37edea6d689e2b9084a08b2c8f050f5"
		)
	]
)