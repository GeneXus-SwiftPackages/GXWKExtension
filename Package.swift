...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "5.0.0-beta.1")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-5.0.0-beta.1.xcframework.zip",
			checksum: "779d63720db00950407d576570821b35b14915d1b50fadd08a9b323b3470d290"
		)
	]
)