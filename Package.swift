...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "3.1.4")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/releases/GXWKExtension-3.1.4.xcframework.zip",
			checksum: "eac26abb8c99335384c30f51bcbb35889ac3cab8022083740070d67a26849405"
		)
	]
)