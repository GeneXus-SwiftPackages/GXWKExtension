...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "3.0.0-rc.15")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/preview/GXWKExtension-3.0.0-rc.15.xcframework.zip",
			checksum: "e5f2418cbeff451f7efdffaa099f56410b894e02603fe42c34477eab59602d3a"
		)
	]
)