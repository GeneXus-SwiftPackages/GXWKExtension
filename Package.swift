...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "3.1.0-beta.0")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-3.1.0-beta.0.xcframework.zip",
			checksum: "3e9d255798715c7f1a412b3b73d9aa6c2d185b418930ab47fcfc7efaa4c199f1"
		)
	]
)