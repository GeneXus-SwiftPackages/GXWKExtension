...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "2.0.0-beta.7")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-2.0.0-beta.7.xcframework.zip",
			checksum: "34a092ded2cabdd95f91deb0ef297253107e3b662ef3106f88a13a84b4c820f7"
		)
	]
)