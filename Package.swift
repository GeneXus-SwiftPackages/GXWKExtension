...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "1.4.31")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/releases/GXWKExtension-1.4.31.xcframework.zip",
			checksum: "6c2a47d2c1ad1722f759f70c10cdc3db86a4e3bc9b2408eedb5043404700909a"
		)
	]
)