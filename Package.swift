...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "3.2.0")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/releases/GXWKExtension-3.2.0.xcframework.zip",
			checksum: "def3a8f6cd0f990a20b3b11131b9ad482afd2a85c321053e24195313842aa441"
		)
	]
)