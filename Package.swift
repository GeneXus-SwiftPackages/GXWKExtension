...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "3.0.0-beta.12")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-3.0.0-beta.12.xcframework.zip",
			checksum: "3ac8f809b18e28e1e1e63c4bff8cbf98a94d5a294f90450e7da6acfa7b114c00"
		)
	]
)