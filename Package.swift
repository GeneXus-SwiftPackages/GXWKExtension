...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "4.1.0-beta.8")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-4.1.0-beta.8.xcframework.zip",
			checksum: "a02dbed5d1b88b1554fd8db3fc15fc5a63a0bc1b4ec10eb674e9589af51da359"
		)
	]
)