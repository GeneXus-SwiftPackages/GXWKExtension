...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-1.0.0-beta+20230330152753.xcframework.zip",
			checksum: "fc521ccb8a0ac216e540cddfdce17367965fc1e191f2ee93114b8245dc28a0df"
		)
	]
)