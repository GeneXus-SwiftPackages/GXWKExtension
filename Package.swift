...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "1.2.0-rc.36")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/preview/GXWKExtension-1.2.0-rc.36.xcframework.zip",
			checksum: "85824e11daa0705d9faabf2fc02df74e3287cc1679348bb7e393405b12091540"
		)
	]
)