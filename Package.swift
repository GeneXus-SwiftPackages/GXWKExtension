...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "1.5.12")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/releases/GXWKExtension-1.5.12.xcframework.zip",
			checksum: "cd7e241cd0e0c4fc5fb1b42894902c2427bfe9eb385d8f95f8092f9acdb0e204"
		)
	]
)