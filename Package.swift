...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "4.1.0-beta.3")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-4.1.0-beta.3.xcframework.zip",
			checksum: "7ab476a3a9b5c1b090900104f191671b9e3d482d4bdc8e90740af504948821ea"
		)
	]
)