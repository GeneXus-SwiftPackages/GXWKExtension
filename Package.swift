...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-1.0.0-beta+20230515023341.xcframework.zip",
			checksum: "77a15b0e0b501d9c0335e03cf5914995bb00e08fbe2dab35a912eaa36d57ae5e"
		)
	]
)