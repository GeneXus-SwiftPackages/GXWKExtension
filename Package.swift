...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "3.0.3")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/releases/GXWKExtension-3.0.3.xcframework.zip",
			checksum: "fcaecc496fed869911466522f73dd6e1cba49503c72088a51aec31901807fa28"
		)
	]
)