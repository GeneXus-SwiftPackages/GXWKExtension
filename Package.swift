...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-1.0.0-beta+20230309150554.xcframework.zip",
			checksum: "90dfcf3777d2e3c433c1955eac69a9b86895ecfab601eddc574ec383a7dabe32"
		)
	]
)