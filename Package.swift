...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "2.1.4")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/releases/GXWKExtension-2.1.4.xcframework.zip",
			checksum: "c68a681fcfad28770ebdca88ebd7d5b30b43d633eb513d22f440c19b1879288f"
		)
	]
)