...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-1.0.0-beta+20230509131236.xcframework.zip",
			checksum: "7651fa1a2346755074cd3f335b511d40aed753b0eb8d4a356cc091f3710cd440"
		)
	]
)