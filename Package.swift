...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "2.0.12")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/releases/GXWKExtension-2.0.12.xcframework.zip",
			checksum: "34d149e5dfaa18e21486bbb2adac0b0ac037023b57e27141d6a45ed6c653af40"
		)
	]
)