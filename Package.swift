...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-1.0.0-beta+20230525122919.xcframework.zip",
			checksum: "089abe9003b0246b2c98c266ccbeaefedbd4c46c304624df6b78eb4d9142bcc7"
		)
	]
)