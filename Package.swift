...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "1.4.0-beta.12")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-1.4.0-beta.12.xcframework.zip",
			checksum: "eedc169750d3ce4add4f1c1b9fd4c4764fcf0cb882add31790ac01c6708f7d7a"
		)
	]
)