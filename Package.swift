...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXUIApplication.git", exact: "3.2.0-beta.22")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXWKExtension",
			url: "https://pkgs.genexus.dev/iOS/beta/GXWKExtension-3.2.0-beta.22.xcframework.zip",
			checksum: "c22483b5d6797ec8c4b24c6bc32749c58591d12abbff633e30fca59546c5e956"
		)
	]
)